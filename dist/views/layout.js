 ...
 * 공통 레이아웃 헬퍼
 */
export function layout(title, body, activePage = '') {
    const nav = [
        ...
        { href: '/ppt-generate', icon: 'fa-file-powerpoint', label: '첨부 및 서류 생성', key: 'ppt-generate' },
        { href: '/ppt-templates', icon: 'fa-layer-group', label: 'PPT 템플릿 관리', key: 'ppt-templates' },
    ];
